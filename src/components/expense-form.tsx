            ...
            {savedExpenses.map((s, i) => (
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-xs text-slate-900 dark:text-slate-100 min-w-0 flex-1 truncate font-headline uppercase font-bold">
      ...
      <div className="bg-white dark:bg-surface-dark border-4 border-slate-950 dark:border-slate-100 rounded-none p-4 space-y-4 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,1)]">
        ...
        <div className="space-y-2.5">
          ...
          {topCategories.length > 0 && (
            <div>
              <p className="text-[11px] font-mono font-bold text-slate-500 uppercase tracking-wider mb-1.5">Sering Dipakai</p>
          ...
          <div className="pt-1">
            <p className="text-[11px] font-mono font-bold text-slate-500 uppercase tracking-wider mb-1.5">Semua Kategori</p>
...
function CategoryChip({
  ...
  return (
    <button
      ...
      onClick={onSelect}
      className={cn(
        "flex items-center gap-2 px-3 py-2 rounded-none text-xs font-headline font-bold uppercase tracking-wider border-2 border-slate-950 dark:border-slate-100 transition-all active:translate-x-[1px] active:translate-y-[1px] active:shadow-none",
        full ? "w-full justify-start" : "",
        selected
          ? "bg-slate-950 text-white dark:bg-slate-100 dark:text-slate-950 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,1)]"
    ...
    >
      <div
        className="w-6 h-6 rounded-none flex items-center justify-center shrink-0 border border-slate-950 dark:border-slate-100"
